...
public class MultiCameraPreviewActivity extends AppCompatActivity implements ICameraErrorListener {

	private static final String TAG = "UsbPreviewActivity";
	...
	private void initView() {
		...
		mUsbCamera = (UsbCameraView) findViewById(R.id.camera_view);
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				mUsbCamera.startPreview(MultiCameraPreviewActivity.this);
			}
		}, 3000);
