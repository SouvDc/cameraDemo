...
public class ImageProc {
	...
	public static final int IMG_WIDTH_1280 = 1280;
	public static final int IMG_WIDTH_640 = 640;
	public static final int IMG_HEIGHT_720 = 720;
	public static final int IMG_HEIGHT_480 = 480;
...
//	public native int nativePrepareCamera(int node,int width, int height, int pixelFormat);
